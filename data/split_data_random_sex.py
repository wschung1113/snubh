...
tmp = {}
for year in df_list:
    tmp[year] = df_list[year][conti_factor + cate_factor_tmp + [disease]].dropna()
...
X_train, X_val, Y_train, Y_val = train_test_split(df_X, df_Y, test_size=0.25, random_state=2021)
